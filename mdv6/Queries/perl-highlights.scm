; Derived (R-43): upstream `tree-sitter-perl` v2.0.0 with one edit — the Neovim-only `#lua-match?`
; predicate on the shebang pattern becomes the runtime's `#match?` (the pattern is a plain regex).
